...
public class JanelaExcluirUsuario extends javax.swing.JFrame {
    ...
    private void botaoExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botaoExcluirActionPerformed
        ...
        conect.deleteUser(campoMatricula.getText());
        setVisible(false);
        JanelaMenu janela = new JanelaMenu();
        janela.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JanelaExcluirUsuario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JanelaExcluirUsuario().setVisible(true);
            }
        });
    }
